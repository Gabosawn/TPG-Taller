defmodule Tpg.Dominio.Receptores.Usuario do
  ...
  def changeset(tipoOperacion, attrs) do
    changeset =
      cast(%Tpg.Dominio.Receptores.Usuario{}, attrs, [:receptor_id, :nombre, :contrasenia])
      |> IO.inspect()
  ...
  def obtener_usuario(attrs) do
    Repo.get_by(Tpg.Dominio.Receptores.Usuario,
      nombre: attrs.nombre,
  ...
  def crear_usuario(changeset) do
    changeset
    |> validate_required([:receptor_id, :nombre, :contrasenia],
      message: "El campo es obligatorio"
    )
    |> put_change(:ultima_conexion, DateTime.utc_now() |> DateTime.truncate(:second))
    |> unique_constraint(:nombre,
      name: "usuarios_nombre_index",
      message: "El nombre de usuario ya existe"
    )
    |> validate_format(:nombre, ~r/^[a-zA-Z0-9]+$/,
      mensaje: "El nombre de usuario debe ser alfanumérico"
    )
    |> check_constraint(:nombre,
      name: "nombre_alfanumerico",
    ...
    |> check_constraint(:contrasenia,
      name: "contrasenia_longitud",
      message: "La contraseña debe tener entre 8 y 50 caracteres"
    )
    |> validate_format(:contrasenia, ~r/[¡!-.*=@]/,
      mensaje: "La contraseña debe contener al menos un carácter especial"
    )
    |> check_constraint(:contrasenia,
      name: "contrasenia_especial",
      message: "La contraseña debe contener al menos un carácter especial"
    )
    |> validate_format(:contrasenia, ~r/[A-Z]/,
      mensaje: "La contraseña debe contener al menos una letra mayúscula"
    )
    |> check_constraint(:contrasenia,
      name: "contrasenia_mayuscula",
    ...
    |> check_constraint(:contrasenia,
      name: "contrasenia_minuscula",
      message: "La contraseña debe contener al menos una letra minúscula"
    )
    |> validate_format(:contrasenia, ~r/^\S+$/,
      mensaje: "La contraseña no debe contener espacios en blanco"
    )
    |> check_constraint(:contrasenia,
      name: "contrasenia_sin_espacios",
      message: "La contraseña no debe contener espacios"
    )
    |> validate_format(:contrasenia, ~r/[0-9]/,
      mensaje: "La contraseña debe contener al menos un número"
    )
    |> check_constraint(:contrasenia,
      name: "contrasenia_numero",
